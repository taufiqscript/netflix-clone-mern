    ...
    return (
        <div className="dropdown dropdown-hover dropdown-end">
            <div className="avatar cursor-pointer">
                <div tabIndex={0} className="w-8 sm:w-10 rounded-full">
                    <img src="https://img.daisyui.com/images/profile/demo/batperson@192.webp" />
                </div>
                <div tabIndex={0} className='dropdown-content '>

                    <button
                        className="relative mt-10 w-28 sm:w-38 bg-black pt-5 sm:pt-4.5 pb-1 px-4 rounded-lg transition-all flex flex-col text-center justify-center border border-white/50">
                        <p className='cursor-text absolute top-0 left-1/2 -translate-x-1/2 italic text-xs sm:text-sm pt-0.5'>{emailStorage}</p>
                        <div className='flex items-center justify-center sm:gap-1 cursor-pointer hover:scale-105 hover:text-red-600 hover:font-semibold transition-all'>
                            <div>
